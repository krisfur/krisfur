...
☁️ Proficient in cloud deployment (VMs, containers, web apps) and data infrastructure on `Azure` and `AWS`, with orchestration through `Apache Airflow` and data management with `Snowflake`.  
